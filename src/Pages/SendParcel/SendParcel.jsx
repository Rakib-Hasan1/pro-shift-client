...
const SendParcel = () => {
  ...
  return (
    <div className="bg-base-100 rounded-2xl p-10 my-8">
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        {/* Heading */}
        <div>
          <h2 className="text-[56px] font-extrabold">Add Parcel</h2>
        </div>
        ...
        <div className="rounded-xl space-y-4">
          <h3 className="font-extrabold text-3xl">Enter your parcel details</h3>
